 ...
 */
public class VacanciaFragment extends Fragment implements View.OnClickListener {




    public VacanciaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.parqueo_fragment_vacancia, container, false);
